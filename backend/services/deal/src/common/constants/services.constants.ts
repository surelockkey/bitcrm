...
export const INVENTORY_SERVICE_URL = process.env.INVENTORY_SERVICE_URL || 'http://localhost:4004';
export const INTERNAL_SERVICE_SECRET = process.env.INTERNAL_SERVICE_SECRET || '';
export const BILLING_SERVICE_URL = process.env.BILLING_SERVICE_URL || 'http://localhost:4008';
