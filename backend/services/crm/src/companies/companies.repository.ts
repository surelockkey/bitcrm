...
export class CompaniesRepository {
  ...
  private toCompany(item: Record<string, unknown>): Company {
    return {
      ...
      isPlatinum: item.isPlatinum as boolean | undefined,
      paymentTerms: item.paymentTerms as Company['paymentTerms'],
      customTermsDays: item.customTermsDays as number | undefined,
      taxExempt: item.taxExempt as boolean | undefined,
      poRequired: item.poRequired as boolean | undefined,
      coiExpiration: item.coiExpiration as string | undefined,
