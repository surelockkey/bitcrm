  ...
  return (
    <span className="relative inline-flex shrink-0">
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className="inline-flex h-7 items-center gap-1.5 rounded-chip border border-foreground/60 bg-background px-3 text-xs font-semibold text-foreground transition-colors hover:bg-muted disabled:opacity-50"
      >
