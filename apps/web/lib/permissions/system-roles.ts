...
export const SYSTEM_ROLES: Record<string, SystemRole> = {
  "role-super-admin": {
    ...
    name: "Super Admin",
    permissions: {
      deals: { ...crud(true, true, true, true), move_status: true },
      service_areas: caps(true, true, true, true, true, true, true),
      contacts: { ...crud(true, true, true, true), view_numbers: true },
      companies: crud(true, true, true, true),
      products: crud(true, true, true, true),
      product_categories: crud(true, true, true, true),
      brands: crud(true, true, true, true),
      ...
      job_sources: crud(true, true, true, true),
      external_companies: crud(true, true, true, true),
      job_tags: crud(true, true, true, true),
      job_statuses: crud(true, true, true, true),
      work_orders: crud(true, true, true, true),
      custom_fields: crud(true, true, true, true),
      commission: { view: true, edit: true },
      documents: { view: true, upload: true, delete: true },
      calls: { view: true, join: true },
      messages: { view: true, send: true, manage: true },
      team_chat: { view: true, send: true, manage_groups: true },
      message_templates: crud(true, true, true, true),
      tax_rates: crud(true, true, true, true),
  ...
  "role-admin": {
    ...
    permissions: {
      ...
      product_categories: crud(true, true, true, false),
      brands: crud(true, true, true, false),
  ...
  "role-dept-manager": {
    ...
    permissions: {
      deals: { ...crud(true, true, true, false), move_status: true },
      service_areas: caps(true, true, true, false, false, true, true),
      contacts: { ...crud(true, true, true, false), view_numbers: true },
      companies: crud(true, true, true, false),
      products: crud(true, false, false, false),
      product_categories: crud(true, false, false, false),
      brands: crud(true, false, false, false),
      ...
      job_sources: crud(true, true, true, false),
      external_companies: crud(true, true, true, false),
      job_tags: crud(true, true, true, false),
      job_statuses: crud(true, true, true, false),
      work_orders: crud(true, true, true, false),
      custom_fields: crud(true, true, true, false),
      commission: { view: true, edit: true },
      documents: { view: true, upload: false, delete: false },
      calls: { view: true, join: true },
      messages: { view: true, send: true, manage: true },
      team_chat: { view: true, send: true, manage_groups: true },
      message_templates: crud(true, true, true, false),
      tax_rates: crud(true, false, false, false),
    ...
    dataScope: scopes(DataScope.DEPARTMENT, {
      ...
      product_categories: DataScope.ALL,
      brands: DataScope.ALL,
  ...
  "role-dispatcher": {
    ...
    permissions: {
      ...
      job_sources: crud(true, false, false, false),
      external_companies: crud(true, false, false, false),
      job_tags: crud(true, false, false, false),
      job_statuses: crud(true, false, false, false),
      work_orders: crud(true, true, true, false),
      custom_fields: crud(true, false, false, false),
      commission: { view: false, edit: false },
      documents: { view: false, upload: false, delete: false },
      calls: { view: true, join: false },
      messages: { view: true, send: true, manage: true },
      team_chat: { view: true, send: true, manage_groups: false },
      message_templates: crud(true, false, false, false),
      tax_rates: crud(true, false, false, false),
      invoices: { ...crud(true, true, true, false), send: true },
      estimates: { ...crud(true, true, true, true), send: true, sync: true },
    ...
    dataScope: scopes(DataScope.DEPARTMENT, {
      ...
      roles: DataScope.ALL,
      settings: DataScope.ALL,
      // Dispatchers work the whole inbox, not just their department.
      messages: DataScope.ALL,
      team_chat: DataScope.ALL,
      message_templates: DataScope.ALL,
    }),
  },
  "role-technician": {
    ...
    name: "Technician",
    permissions: {
      deals: { ...crud(true, false, true, false), move_status: true },
      service_areas: caps(true, false, false, false, true, false, false),
      contacts: { ...crud(true, false, false, false), view_numbers: true },
      companies: crud(true, false, false, false),
      products: crud(true, false, false, false),
      product_categories: crud(true, false, false, false),
      brands: crud(true, false, false, false),
  ...
  "role-read-only": {
    ...
    name: "Read Only",
    permissions: {
      deals: { ...crud(true, false, false, false), move_status: false },
      service_areas: caps(true, false, false, false, false, false, false),
      contacts: { ...crud(true, false, false, false), view_numbers: true },
      companies: crud(true, false, false, false),
      products: crud(true, false, false, false),
      ...
      job_tags: crud(true, false, false, false),
      job_statuses: crud(true, false, false, false),
      work_orders: crud(true, false, false, false),
      custom_fields: crud(true, false, false, false),
      commission: { view: true, edit: false },
      documents: { view: false, upload: false, delete: false },
      calls: { view: true, join: false },
      messages: { view: true, send: false, manage: false },
      team_chat: { view: true, send: false, manage_groups: false },
      message_templates: crud(true, false, false, false),
      tax_rates: crud(true, false, false, false),
