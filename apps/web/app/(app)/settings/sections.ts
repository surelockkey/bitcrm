...
export const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  },
  {
    ...
    description: "How products are filed. Categories nest, and disabling one takes its subcategories with it.",
    icon: FolderTree,
    resource: "products",
  },
  {
    ...
    description: "Manufacturers you buy from. A product picks one brand.",
    icon: Tag,
    resource: "products",
  },
  {
